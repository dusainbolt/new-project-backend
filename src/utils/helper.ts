...
import { MsgResponse } from "./type";

export class Helper {
  static mapFromArray<T>(array: T[], keyStrategy: (v: T) => string | number) {
  ...
  static apolloError = (msg: MsgResponse) => {
    return new ApolloError(msg.message, msg.code);
  };
...
//     const limit = params?.limit || Constant.find.LIMIT;
//     return {
//       limit,
//       offset: !!params?.offset ? params.offset * limit : Constant.find.OFFSET,
//       orderBy:
//         params?.orderBy && params?.sortBy
//           ? params?.orderBy
//           : Constant.find.ORDER_BY,
//       sortBy: params?.sortBy || Constant.find.DESC,
//     };
//   };
